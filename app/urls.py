...
urlpatterns = [
    ...
    path('catalog/<slug:category_slug>/', views.product.ProductCategorizedListView.as_view(), name='catalog'),
    path('catalog/<slug:category_slug>/<int:pk>', views.product.ProductDetailView.as_view(), name='product'),
